"""Generate a Toronto -> Kingston trace with a ~40 km geofence gap, then
...
# Toronto (CN Tower) -> Kingston (City Hall)
ORIGIN = (43.6426, -79.3871)
DESTINATION = (44.2312, -76.4860)

# Roughly on Hwy 401 near Belleville, midway between the two cities.
# 25 km radius removes ~50 km of route.
GEOFENCE_CENTER = (44.1628, -77.3832)
...
def main(args: argparse.Namespace) -> None:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        print(f"Generating Toronto -> Kingston trace (seed={config.seed})...")
        ...
        if args.serve:
            ...
            out_path = OUTPUT_DIR / "geofence_gap_toronto_kingston.html"
            save_map(m, out_path)
