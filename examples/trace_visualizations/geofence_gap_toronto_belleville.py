"""Generate a Toronto -> Belleville trace with a ~60 km geofence gap, then
...
# Toronto (CN Tower) -> Belleville (City Hall)
ORIGIN = (43.6426, -79.3871)
DESTINATION = (44.1628, -77.3832)

# Roughly on Hwy 401 near Cobourg, midway between the two cities.
# 30 km radius removes ~60 km of route.
GEOFENCE_CENTER = (43.9593, -78.1677)
...
def main(args: argparse.Namespace) -> None:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        print(f"Generating Toronto -> Belleville trace (seed={config.seed})...")
        ...
        if args.serve:
            ...
            out_path = OUTPUT_DIR / "geofence_gap_toronto_belleville.html"
            save_map(m, out_path)
